...
3.  Templates and overlays are selected.
4.  PFXStudy schedules jobs under license limits.
5.  PFXCore executes runs.
6.  Results are indexed and aggregated.
...
2.  Path allocation (PFXStudy)
3.  Composition (PFXCore)
4.  Normalization
5.  Execution
6.  Harvesting
7.  Intent recording
...
### 3.10 Run Indexing and Discovery
...
Defines the DOE directory structure.
