...
### X.7 Variable Export (Default: Export Everything)

PFXCore SHALL export **all** values from `tech.toml` into `pfx_vars.tcl`, subject to the export restrictions below.
...
### Y.8 Variable Export (Default: Export Everything)

PFXCore SHALL export **all** values from `design.toml` into `pfx_vars.tcl`, subject to the export restrictions below.

#### Y.8.1 Exported Keyspace
...
#### Y.8.2 Export Restrictions (Hard)
