...
challenges: 
- A standardized interface for RTL, constraint, and
technology inputs 
- Deterministic normalization of design data Integrated license-aware and compute-aware orchestration 
...
- A consistent, meaningful directory structure reflecting DOE structure 
- A robust, explicit stage pipeline and artifact handoff contract within each run directory
