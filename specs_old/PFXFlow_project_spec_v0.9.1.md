...
-   2026-02-05 -- Restored and formalized variable propagation; defined
    ...
    clarified logging and execution semantics (v0.9.1)
...
The `[conventions]` table defines pipeline-wide defaults used by PFXCore when
materializing stage directories and filenames.

| Field       | Type   | Default      | Description                           |
|------------|--------|--------------|---------------------------------------|
| stages_dir  | string | "stages"     | Stage directory root                  |
| status_file | string | "status.json"| Stage status filename (stage-relative)|
...
Stage names SHALL be unique.
Order values SHALL be unique and increasing.
